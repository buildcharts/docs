...
- [ORAS](https://oras.land/) for general OCI artifact workflows and registry operations
- [Helm](https://helm.sh/docs/topics/registries/) for Helm-style charts in OCI registries
- [Kustomizer](https://kustomizer.dev/) for packaging and publishing Kubernetes manifests as OCI artifacts
