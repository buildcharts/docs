...
If you want signed charts, use OCI-native signing tooling outside of BuildCharts:

These tools are typically used to sign OCI artifacts in registries and verify them at pull or promotion time under your supply-chain policy.
