...
In other words, BuildCharts does not just detect that a repository is `.NET`. It also tries to map each discovered file to the correct stage type automatically.
