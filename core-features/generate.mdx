...
<Tip>
  Currently the `build.yml` is transformed using a Docker bake HCL specific generator. However since it acts as an interface with minimal intent you can easily clone the code and implement your own generators.
</Tip>
