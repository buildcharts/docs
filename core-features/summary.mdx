...
This gives you both a human-readable summary and a portable Buildx record you can inspect later. On GitHub Actions, the command also appends the generated summary to `GITHUB_STEP_SUMMARY`.
...
- [Docker Bake](/core-features/docker-bake)
