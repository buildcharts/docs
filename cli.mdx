...
| ---------- | ------------------------------------------------------------- |
| `clean`    | <Badge color="red" size="sm">WIP</Badge>                      |
| `diff`     | <Badge color="red" size="sm">WIP</Badge>                      |
| `explain`  | <Badge color="red" size="sm">WIP</Badge>                      |
...
| `package`  | <Badge color="red" size="sm">WIP</Badge>                      |
...
| `validate` | <Badge color="red" size="sm">WIP</Badge>                      |
