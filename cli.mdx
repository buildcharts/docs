...
| ---------- | -------------------------------------------------------------   |
| `clean`    | <Badge color="yellow" size="sm">WIP</Badge>                      |
| `diff`     | <Badge color="yellow" size="sm">WIP</Badge>                      |
| `explain`  | <Badge color="yellow" size="sm">WIP</Badge>                      |
...
| `package`  | <Badge color="yellow" size="sm">WIP</Badge>                      |
...
| `validate` | <Badge color="yellow" size="sm">WIP</Badge>                      |
