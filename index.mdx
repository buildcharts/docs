...
- **Infrastructure as code for builds.** Helm charts are an infrastructure-as-code pattern for Kubernetes deployments. BuildCharts applies the same idea to build pipelines by treating them as platform-owned and versioned artifacts.
