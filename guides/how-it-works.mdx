---
title: "How it works"
description: "Understand the inputs, validation rules, generated files, and Bake outputs."
---
...
Each axis value is exposed to the chart as an uppercase snake case build arg. In this example, the generated Bake plan exposes `PLATFORM`.
